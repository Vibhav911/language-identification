...
class DataIngestions:
    def __init__(self, data_ingestion_config: DataIngestionConfig, s3_sync: S3Sync):
        try:
    ...
    def unzip_data(self) -> Path:
        ...
        try:
            ...
            logging.info("Unzipped file exists in unzip directory: {unzip_data_path}")
    ...
    def rename(self) -> None:
        ...
        try:
            ...
            unzip_data_path = self.data_ingestion_config.unzip_data_dir_path
            extract_dir_path = os.path.join(unzip_data_path, UNZIPPED_FOLDERNAME)
