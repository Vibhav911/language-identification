...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> Tuple[float, float]:
        ...
        try:
            ...
            if best_model_path is not None:
                ...
                logging.info(
                    f"Locally trained accuracy is {self.model_trainer_artifacts.model_accuracy}")
    ...
    def initiate_model_evaluation(self):
        """
        The function initiates the model evaluation process by evaluating the trained model against the
        model in S3
        """
        try:
            ...
            trained_model_accuracy = self.model_trainer_artifacts.model_accuracy
            trained_model_loss = self.model_trainer_artifacts.model_loss
